        ...
        <div class="container-fluid">
            <div class="row" style="background-color: dimgrey; padding-top: 10px; padding-bottom: 10px; padding-right: 20px;">
                <ul class="form-inline my-2 my-lg-0 mr-auto">
                    <a href="form.php"><button name="btnBack" class="btn btn-primary my-2 my-sm-0" type="submit">Kembali</button></a>
                </ul>
            </div>
            <br>
            <h3 align="center" style="font-family: Arial, Helvetica, sans-serif;">List Tag Departemen <?php echo $_SESSION['departemen'];?></h3>
            <div class="table-responsive-sm" style="padding-left: 5%; padding-right: 5%;">
                <table class="table">
                    ...
                    try {
                        ?>
                        <?php
                            $sql = "SELECT *, DATEDIFF(CURDATE(),tanggal) AS 'beda' FROM tag WHERE departemen = '".$_SESSION['departemen']."' ORDER BY tanggal DESC";
                        ...
                        <?php
                            if($row['beda'] <= 0){
                        ?>
                        <a href="form.php?id=<?php echo $row['id'];?>" onClick="return confirm('Anda yakin untuk menghapus data tanggal <?php echo $row['tanggal']." ".$row['waktu']." hari";?>?')"><i class="far fa-trash-alt btn btn-danger"></i></a>
                        <?php } ?>
                        </td>
                        </tr>
                        <?php
