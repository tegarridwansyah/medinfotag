        ...
        <div class="container-fluid">
            <div class="row" style="background-color: dimgrey; padding-top: 10px; padding-bottom: 10px; padding-right: 20px;">
                <ul class="form-inline my-2 my-lg-0 mr-auto">
                    <a href="admin_list.php"><button name="btnBack" class="btn btn-primary my-2 my-sm-0" type="submit">Kembali</button></a>
                </ul>
            </div>
            <br>
            <form method="POST" action="admin.php" style="padding-left: 5%; padding-right: 5%;">
                <h3 align="center">Edit Tag</h3>
                <div class="form-group row">
                    <label for="staticEmail" class="col-sm-2 col-form-label">Departemen</label>
                    <div class="col-sm-10">
                        <input type="hidden" name="id" value="<?php echo $_GET['id'];?>">
                        <input name="inputDepartemen" type="text" readonly class="form-control-plaintext" id="staticEmail" value="<?php echo $row['departemen'];?>">
                    </div>
                </div>
                <div class="form-group row">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                        <input name="inputKeterangan" type="text" class="form-control" id="staticEmail" value="<?php echo $row['keterangan'];?>">
                    </div>
                </div>
